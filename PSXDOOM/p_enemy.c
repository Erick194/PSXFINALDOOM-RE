...
*/
//inline
boolean P_CheckMeleeRange (mobj_t *actor)//L8001617C()
{
	mobj_t		*pl;
	fixed_t		dist;
...
*/
//inline
boolean P_CheckMissileRange (mobj_t *actor)//L800161F0()
{
	fixed_t		dist;
...
boolean P_Move (mobj_t *actor)//L800162D4()
{
	fixed_t	tryx, tryy;
	boolean		good;
	line_t		*blkline;
...
*/
//inline
boolean P_TryWalk (mobj_t *actor)//L8001643C()
{
	if (!P_Move (actor))
		return false;
...
void P_NewChaseDir (mobj_t *actor)//L80016488()
{
...
boolean P_LookForPlayers (mobj_t *actor, boolean allaround)//L80016808()
{
	angle_t		an;
	fixed_t		dist;
	mobj_t		*mo;
...
void A_Look (mobj_t *actor)//L80016988()
{
	mobj_t	*targ;
	int		sound;
...
void A_Chase (mobj_t *actor)//L80016AB4()
{
	int		delta;
...
*/
//inline
void A_FaceTarget (mobj_t *actor)//L80016DFC()
{
	if (!actor->target)
		return;
...
void A_PosAttack (mobj_t *actor)//L80016EA0()
{
	int		angle, damage;
...
void A_SPosAttack (mobj_t *actor)//L80016FA8()
{
	int		i;
...
void A_CPosAttack(mobj_t* actor)//L800170F8()
{
	int		angle;
	int		bangle;
	int		damage;
...
void A_CPosRefire(mobj_t* actor)//L80017244()
{
	A_FaceTarget(actor);
...
void A_SpidAttack(mobj_t *actor)//L80017340()
{
	int i;
	int angle, bangle, damage;
...
void A_SpidRefire (mobj_t *actor)//L80017490()
{
...
void A_BspiAttack(mobj_t *actor)//L80017590()
{
	if (!actor->target)
		return;
...
void A_TroopAttack (mobj_t *actor)//L80017644()
{
	int		damage;
...
void A_SargAttack (mobj_t *actor)//L80017784()
{
	int		damage;
...
void A_HeadAttack (mobj_t *actor)//L80017854()
{
	int		damage;
...
void A_CyberAttack (mobj_t *actor)//L80017988()
{
	if (!actor->target)
		return;
...
void A_BruisAttack (mobj_t *actor)//L80017A3C()
{
	int		damage;
...
void A_SkelMissile(mobj_t *actor) //L80017b04()
{
	mobj_t*	mo;
...
void A_Tracer(mobj_t *actor) //L80017C04()
{
	angle_t	exact;
	fixed_t	dist;
	fixed_t	slope;
...
void A_SkelWhoosh(mobj_t* actor) //L80017E54()
{
	if (!actor->target)
		return;
	A_FaceTarget(actor);
...
void A_SkelFist(mobj_t*	actor) //L80017F04()
{
	int	damage;
...
void A_FatRaise(mobj_t *actor)//L80018064()
{
	A_FaceTarget(actor);
...
void A_FatAttack1(mobj_t *actor)//L80018114()
{
	mobj_t  *mo;
	mobj_t  *target;
	int	    an;
...
void A_FatAttack2(mobj_t *actor)//L80018250()
{
    mobj_t  *mo;
	mobj_t  *target;
	int	    an;
...
void A_FatAttack3(mobj_t *actor)//L8001838C()
{
    mobj_t  *mo;
	mobj_t  *target;
	int	    an;
...
void A_SkullAttack (mobj_t *actor)//L80018520()
{
	mobj_t			*dest;
	angle_t			an;
	int				dist;
...
void A_PainAttack(mobj_t *actor)//L80018810()
{
	if (!actor->target)
		return;
...
void A_PainDie(mobj_t *actor)//L800189CC()
{
	A_Fall(actor);
...
void A_Scream (mobj_t *actor)//L80018D4C()
{
	int		sound;
...
void A_XScream (mobj_t *actor)//L80018E04()
{
...
void A_Pain (mobj_t *actor)//L80018E24()
{
...
void A_Fall (mobj_t *actor)//L80018E5C()
{
...
void A_Explode (mobj_t *thingy)//L80018E70()
{
...
void A_BossDeath (mobj_t *mo)//L80018E94()
{
	mobj_t		*mo2;
	line_t		junk;
...
void A_Hoof (mobj_t *mo)//L800190B4()
{
...
void A_Metal (mobj_t *mo)//L800190E8()
{
...
void A_BabyMetal(mobj_t* mo)//L8001911C()
{
...
void L_MissileHit (mobj_t *mo)//L80019150()
{
	int	damage;
	mobj_t	*missilething;
...
void L_SkullBash (mobj_t *mo)//L800191C4()
{
	int	damage;
	mobj_t	*skullthing;

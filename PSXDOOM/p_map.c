...
boolean P_CheckPosition (mobj_t *thing, fixed_t x, fixed_t y)//L8001BAB0()
{
    checkposonly = true;
...
boolean P_TryMove (mobj_t *thing, fixed_t x, fixed_t y)//L8001BAEC()
{
	int		damage;
...
*/
//inline
fixed_t P_InterceptVector (divline_t *v2, divline_t *v1)//L8001BC14()
{
...
boolean	PIT_UseLines (line_t *li)//L8001BCB8()
{
	divline_t	dl;
	fixed_t		frac;
...
void P_UseLines (player_t *player) //L8001BE64()
{
	int			angle;
	fixed_t		x1, y1, x2, y2;
	int			x,y, xl, xh, yl, yh;
...
boolean PIT_RadiusAttack (mobj_t *thing)//L8001C0A0()
{
	fixed_t		dx, dy, dist;
...
void P_RadiusAttack (mobj_t *spot, mobj_t *source, int damage)//L8001C194()
{
	int			x,y, xl, xh, yl, yh;
	fixed_t		dist;
...
fixed_t P_AimLineAttack (mobj_t *t1, angle_t angle, fixed_t distance)//L8001C274()
{
...
void P_LineAttack (mobj_t *t1, angle_t angle, fixed_t distance, fixed_t slope, int damage)//L8001C2E8()
{
	line_t	*shootline2;

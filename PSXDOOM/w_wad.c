...
int	W_CheckNumForName (char *name)//L80031730()
{
	char	name8[12];
	int		v1,v2;
	lumpinfo_t	*lump_p;
...
int	W_GetNumForName (char *name)//L800317E4()
{
	int	i;
...
int W_LumpLength (int lump)//L800318D4()
{
	if (lump >= numlumps)
...
*/
//inline
void W_ReadLump (int lump, void *dest, boolean decodelump)//L80031924()
{
	/*byte *input;
	lumpinfo_t	*l;
	int lumpsize;
...
void	*W_CacheLumpNum (int lump, int tag, boolean decodelump)//L80031A38()
{
    int lumpsize;
    lumpcache_t *lc;
...
void	*W_CacheLumpName (char *name, int tag, boolean decodelump)//L80031C70()
{
...
byte *W_OpenMapWad(char *mapname)//L80031D90()
{
...
int W_MapLumpLength(int lump)//L80031E60()
{
	if (lump >= mapnumlumps)
...
int W_MapGetNumForName(char *name)//L80031EB0()
{
	char	name8[16];
	int		v1, v2;
	lumpinfo_t	*lump_p;
...
void W_ReadMapLump(int lump, void *dest, int decodelump)//L80031F6C()
{
	lumpinfo_t *l;
	int lumpsize;
...
void decode(unsigned char *input, unsigned char *output)//L8003201C()
{
	int getidbyte = 0;
	int len;
	int pos;
...
int decodedsize(unsigned char *input)//L800320D4()
{
	int getidbyte = 0;
	int len;
	byte idbyte;

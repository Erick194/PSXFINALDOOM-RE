...
*/
//inline
void P_RemoveMobj (mobj_t *mobj)//L8001CB94()
{
	int		spot;
...
void P_RespawnSpecials (void)//L8001CCA8()
{
	fixed_t         x,y,z;
	subsector_t 	*ss;
	mobj_t			*mo;
...
boolean P_SetMobjState (mobj_t *mobj, statenum_t state)//L8001CE88()
{
	state_t	*st;
...
*/
//inline
void P_ExplodeMissile (mobj_t *mo)//L8001D00C()
{
...
//int zonetics;
//inline
mobj_t *P_SpawnMobj (fixed_t x, fixed_t y, fixed_t z, mobjtype_t type)//L8001D0D8()
{
	mobj_t		*mobj;
	state_t		*st;
	mobjinfo_t	*info;
...
void P_SpawnPlayer (mapthing_t *mthing)//L8001D2B0()
{
	player_t	*p;
	fixed_t		x,y,z;
	mobj_t		*mobj;
...
void P_SpawnMapThing (mapthing_t *mthing)//L8001D5F0()
{
	int			i, bit;
	mobj_t		*mobj;
	fixed_t		x,y,z;
...
void P_SpawnPuff (fixed_t x, fixed_t y, fixed_t z)//L8001DB70()
{
	mobj_t	*th;
...
void P_SpawnBlood (fixed_t x, fixed_t y, fixed_t z, int damage)//L8001DD9C()
{
	mobj_t	*th;
...
*/
//inline
void P_CheckMissileSpawn (mobj_t *th)//L8001DFE4()
{
	th->x += (th->momx>>1);
...
mobj_t *P_SpawnMissile (mobj_t *source, mobj_t *dest, mobjtype_t type)//L8001E100()
{
	mobj_t		*th;
	angle_t		an;
	int			dist;
...
void P_SpawnPlayerMissile (mobj_t *source, mobjtype_t type)//L8001E560()
{
	mobj_t			*th;
	angle_t			an;
	fixed_t			x,y,z, slope;

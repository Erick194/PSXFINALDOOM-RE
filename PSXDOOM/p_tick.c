...
void P_AddThinker (thinker_t *thinker)//L80029148()
{
...
void P_RemoveThinker (thinker_t *thinker)//L80029178()
{
...
*/
//inline
void P_RunThinkers (void)//L80029184()
{
...
//inline
void P_RunMobjLate (void)//L80029240()
{
	mobj_t	*mo;
	mobj_t	*next;
...
void P_CheckCheats (void)//L800292A4()
{
    ...
    for (i = 0; i < NUMCHEATS; i++)
    {
        ...
        if (j >= 8)
        {
            ...
            case CH_NOCLIP: //Enabled in PsyDoom (StationDoom)
...
void P_Stop (int exit)//L80029C34()
{
	int i;

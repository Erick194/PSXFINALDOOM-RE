...
/* */
/*================================================================== */
void T_VerticalDoor (vldoor_t *door)//L800157D0()
{
	result_e	res;
...
boolean P_CheckKeyLock(line_t *line, mobj_t *thing)//L80015A14()
{
	player_t *player;
...
/* */
/*================================================================== */
int EV_DoDoor (line_t *line, vldoor_e  type)//L80015C38()
{
	int			secnum,rtn;
	sector_t		*sec;
	vldoor_t		*door;
...
/* */
/*================================================================== */
void EV_VerticalDoor (line_t *line, mobj_t *thing)//L80015E5C()
{
	player_t		*player;
	int				secnum;
	sector_t		*sec;
...
/* */
/*================================================================== */
void P_SpawnDoorCloseIn30 (sector_t *sec)//L80016058()
{
	vldoor_t	*door;
...
/* */
/*================================================================== */
void P_SpawnDoorRaiseIn5Mins (sector_t *sec, int secnum)//L800160d8()
{
	vldoor_t	*door;

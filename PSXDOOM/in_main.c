...
void IN_Stop(int exit)//L8003D5CC()
{
	IN_Drawer();
	psxcd_stop();
}

int IN_Ticker(void)//L8003D5F4()
{
	int i, j, playsound;
...
/* Single intermision */
/* */
void IN_SingleDrawer(void)//L8003DA4C()
{
	int i;
	char password[16];
...
/* */
void IN_CooperativeDrawer(void)//L8003DC1C()
{
	int i;
	char password[16];
...
/* */
void IN_DeathMachtDrawer(void)//L8003DFB0()
{
	int i;

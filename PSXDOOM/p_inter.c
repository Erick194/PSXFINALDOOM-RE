...
boolean P_GiveAmmo (player_t *player, ammotype_t ammo, int num)//L80019C14()
{
	int		oldammo;
...
boolean P_GiveWeapon (player_t *player, weapontype_t weapon, boolean dropped)//L80019DFC()
{
...
*/
//inline
boolean P_GiveBody (player_t *player, int num)//L80019F64()
{
...
*/
//inline
boolean P_GiveArmor (player_t *player, int armortype)//L80019FB0()
{
	int		hits;
...
*/
//inline
void P_GiveCard (player_t *player, card_t card)//L80019FEC()
{
...
*/
//inline
boolean P_GivePower (player_t *player, powertype_t power)//L8001A018()
{
    if(power >= NUMPOWERS)
        return false;
...
void P_TouchSpecialThing (mobj_t *special, mobj_t *toucher)//L8001A0FC()
{
	player_t	*player;
	int			i;
	fixed_t		delta;
...
void P_KillMobj (mobj_t *source, mobj_t *target)//L8001A9EC()
{
	mobjtype_t		item;
	mobj_t			*mo;
	boolean         forceXdeath;
...
void P_DamageMobj (mobj_t *target, mobj_t *inflictor, mobj_t *source, int damage)//L8001AD10()
{
	unsigned	ang, an;
	int			saved;
	player_t	*player;

...
fixed_t am_maxleft;     //iGp00000cd8
fixed_t am_maxright;    //iGp00000ce4
fixed_t am_maxtop;      //iGp00000ce8
fixed_t am_maxbottom;   //iGp00000cf0
...
void AM_Control (player_t *player)//L8003C670()
{
...
//Update OutCode Flags From PsyDoom (StationDoom) By BodbDearg
void AM_DrawLine(int color, int x1, int y1, int x2, int y2)//L8003CF58()
{

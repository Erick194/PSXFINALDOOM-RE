...
void P_InitPicAnims (void)//L80026454()
{
	int		i, lump;
...
/* */
side_t *getSide(int currentSector,int line, int side)//L80026734()
{
...
/*		the line number and the side (0/1) that you want. */
/* */
sector_t *getSector(int currentSector,int line,int side)//L80026790()
{
...
/* */
int	twoSided(int sector,int line)//L800267F4()
{
...
/* */
/*================================================================== */
sector_t *getNextSector(line_t *line,sector_t *sec)//L80026834()
{
...
/* */
/*================================================================== */
fixed_t	P_FindLowestFloorSurrounding(sector_t *sec)//L80026864()
{
	int			i;
	line_t		*check;
	sector_t	*other;
...
/* */
/*================================================================== */
fixed_t	P_FindHighestFloorSurrounding(sector_t *sec)//L800268f8()
{
	int			i;
	line_t		*check;
	sector_t	*other;
...
/* */
/*================================================================== */
fixed_t	P_FindNextHighestFloor(sector_t *sec,int currentheight)//L80026990()
{
    #if P_FNHF_UPDATE == 1
...
/* */
/*================================================================== */
fixed_t	P_FindLowestCeilingSurrounding(sector_t *sec)//L80026A74()
{
	int			i;
	line_t		*check;
	sector_t	*other;
...
/* */
/*================================================================== */
fixed_t	P_FindHighestCeilingSurrounding(sector_t *sec)//L80026B10()
{
	int	i;
	line_t	*check;
	sector_t	*other;
...
/* */
/*================================================================== */
int	P_FindSectorFromLineTag(line_t	*line,int start)//L80026BA8()
{
	int	i;
...
void P_CrossSpecialLine (line_t *line, mobj_t *thing)//L80026CA4()
{
	int			ok;
...
void	P_ShootSpecialLine ( mobj_t *thing, line_t *line)//L80027250()
{
	int		ok;
...
void P_PlayerInSpecialSector (player_t *player)//L80027318()
{
	sector_t	*sector;
...
void P_UpdateSpecials (void)//L800274D8()
{
	anim_t		*anim;
	int			i;
	line_t		*line;
...
void P_SpawnDelayTimer(int tics, void(*action)())//L80027BB8()
{
	delay_t *timer;
...
void T_CountdownTimer(delay_t *timer)//L80027C28()
{
	if ((timer->tics--) <= 0)
	{
		timer->finishfunc();
...
void P_ExitLevel(void)//L80027C78()
{
	nextmap = gamemap + 1;
...
void P_SecretExitLevel(int map)//L80027CF0()
{
	nextmap = map;
	P_SpawnDelayTimer(4, G_CompleteLevel);
}
...
void P_SpawnSpecials (void)//L80027D5C()
{
	sector_t	*sector;
	int		i;
...
void P_FireSky(psxobj_t *psxobj)//L800281C0()
{
    byte *src, *srcoffset;

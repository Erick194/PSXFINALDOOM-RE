...
/* */
/*================================================================== */
int EV_DoCeiling (line_t *line, ceiling_e  type)//L80015118()
{
	int			secnum,rtn;
	sector_t		*sec;
	ceiling_t		*ceiling;
...
/* */
/*================================================================== */
void P_AddActiveCeiling(ceiling_t *c)//L800152EC()
{
	int		i;
...
/* */
/*================================================================== */
void P_RemoveActiveCeiling(ceiling_t *c)//L80015328()
{
	int		i;
...
/* */
/*================================================================== */
void P_ActivateInStasisCeiling(line_t *line)//L80015390()
{
	int	i;
...
/* */
/*================================================================== */
int	EV_CeilingCrushStop(line_t	*line)//L80015404()
{
	int		i;
	int		rtn;

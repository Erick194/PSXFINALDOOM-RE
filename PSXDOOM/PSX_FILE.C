...
void ClearFiles(void)//L80032140()
{
	int i;
...
int OpenFile(char *filename)//L80032168()
{
	PsxCd_File *fp;
	int i, j;
...
void CloseFile(int file_num)//L80032264()
{
...
int SeekFile(int file_num, int seekpos, int seekmode)//L800322b0()
{
    PsxCd_File *fileptr;
    int tell;

...
memzone_t *Z_InitZone(byte *base, int size)//L80032428()
{
	memzone_t *zone;
...
void *Z_Malloc2 (memzone_t *mainzone, int size, int tag, void *user)//L8003245C()
{
	int		extra;
...
void *Z_Alloc2(memzone_t *mainzone, int size, int tag, void *user)//L80032654()
{
	int		extra;
...
/*inline */void Z_Free2(memzone_t *mainzone, void *ptr)//L80032864()
{
	memblock_t	*block;
...
void Z_FreeTags (memzone_t *mainzone, int tag)//L800328CC()
{
...
void Z_CheckHeap (memzone_t *mainzone)//L80032A04()
{
...
void Z_ChangeTag (void *ptr, int tag)//L80032ACC()
{
	memblock_t	*block;
...
int Z_FreeMemory (memzone_t *mainzone)//L80032B58()
{
	memblock_t	*block;
	int			free;
...
void Z_DumpHeap(memzone_t *mainzone)//L80032B98()
{
#if DEBUG
	memblock_t	*block;

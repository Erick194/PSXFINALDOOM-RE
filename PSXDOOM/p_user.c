...
//inline
void P_PlayerXYMovement (mobj_t *mo)//L80029DFC()
{
	P_PlayerMove (mo);
...
*/
//inline
void P_PlayerZMovement (mobj_t *mo)//L8002A008()
{
	/* */
...
void P_PlayerMobjThink (mobj_t *mobj)//L8002A138()
{
	state_t	*st;
	int		state;
...
void P_BuildMove (player_t *player) //L8002A30C()
{
	int         speed;
...
*/
//inline
void P_Thrust (player_t *player, angle_t angle, fixed_t move) //L8002A74C()
{
...
void P_CalcHeight (player_t *player) //L8002A7EC()
{
	int			angle;
	fixed_t		bob;
	fixed_t		val;
...
void P_MovePlayer (player_t *player)//L8002A9A8()
{
...
void P_DeathThink (player_t *player)//L8002ABC8()
{
	angle_t		angle, delta;
...
void P_PlayerThink (player_t *player)//L8002AD24()
{
	int		     buttons, oldbuttons;
	buttons_t    *cbutton;

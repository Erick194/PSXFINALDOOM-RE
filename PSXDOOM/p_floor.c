...
result_e	T_MovePlane(sector_t *sector,fixed_t speed,
			fixed_t dest,boolean crush,int floorOrCeiling,int direction)//L80019260()
{
	boolean	flag;
	fixed_t	lastpos;
...
/* */
/*================================================================== */
void T_MoveFloor(floormove_t *floor)//L80019480()
{
	result_e	res;
...
/* */
/*================================================================== */
int EV_DoFloor(line_t *line,floor_e floortype)//L80019570()
{
	int			secnum;
	int			rtn;
	int			i;
...
/* */
/*================================================================== */
int EV_BuildStairs(line_t *line, stair_e type)//L800199b8()
{
	int		secnum;
	int		height;
	int		i;

...
void P_TryMove2(void)//L8001E960()
{
	int		side;
	int		oldside;
	line_t	*line;
...
void PM_UnsetThingPosition(mobj_t *thing)//L8001EBD8()
{
	int blockx, blocky;
...
void PM_SetThingPosition(mobj_t *thing)//L8001ECD4()
{
	sector_t     *sec;
	int           blockx, blocky;
	mobj_t      **link;
...
void PM_CheckPosition (void) //L8001EDE4()
{
...
*/
//inlne
boolean PM_BoxCrossLine (line_t *ld)//L8001F0D4()
{
	fixed_t		x1, y1, x2, y2;
	fixed_t		lx, ly;
	fixed_t		ldx, ldy;
...
boolean PIT_CheckLine (line_t *ld)//L8001F1E0()
{
...
boolean PIT_CheckThing(mobj_t *thing)//L8001F330()
{
	fixed_t blockdist;
	int			delta;
...
boolean PM_BlockLinesIterator(int x, int y)//L8001F494()
{
	int     offset;
	short  *list;
	line_t *ld;
...
boolean PM_BlockThingsIterator(int x, int y)//L8001F674()
{
	mobj_t *mobj;

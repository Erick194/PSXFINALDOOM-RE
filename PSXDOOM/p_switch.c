...
void P_InitSwitchList(void)//L80028294()
{
	int		i;
	int		index;
	int		tex1, tex2;
...
/* */
/*================================================================== */
void P_StartButton(line_t *line,bwhere_e w,int texture,int time)//L800283b8()
{
	int		i;
...
/* */
/*================================================================== */
void P_ChangeSwitchTexture(line_t *line,int useAgain)//L8002844C()
{
	int	texTop;
	int	texMid;
	int	texBot;
...
boolean P_UseSpecialLine ( mobj_t *thing, line_t *line)//L8002873C()
{
	/* */

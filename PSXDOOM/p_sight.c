...
void P_CheckSights(void)//L80024E18()
{
	mobj_t *mobj;
...
boolean P_CheckSight(mobj_t *t1, mobj_t *t2)//L80024EC4()
{
	int	s1, s2;
...
//inline
fixed_t PS_SightCrossLine (line_t *line)//L8002504C()
{
	int			s1, s2;
...
boolean PS_CrossSubsector(subsector_t *sub)//L80025124()
{
	seg_t		*seg;
	line_t		*line;
	int			count;
...
boolean PS_CrossBSPNode(int bspnum)//L800253D0()
{
	node_t *bsp;
	int side;
	int bsp_num;

...
*/
//inline
void P_LoadVertexes (int lump)//L80021F38()
{
	byte		*data;
	int			i, lumpSize;
	mapvertex_t	*ml;
...
void P_LoadSegs (int lump)//L8002200C()
{
	byte		*data;
	int			i;
	mapseg_t	*ml;
...
*/
//inline
void P_LoadSubsectors (int lump)//L80022240()
{
	byte			*data;
	int				i;
	mapsubsector_t	*ms;
...
void P_LoadSectors (int lump)//L8002232C()
{
	byte			*data;
	int				i;
	mapsector_t		*ms;
...
void P_LoadNodes (int lump)//L80022540()
{
	byte		*data;
	int			i,j,k;
	mapnode_t	*mn;
...
//inline
void P_LoadThings (int lump)//L800226B4()
{
	byte			*data;
...
void P_LoadLineDefs (int lump)//L800227E8()
{
	byte			*data;
	int				i;
	maplinedef_t	*mld;
...
void P_LoadSideDefs (int lump)//L80022AB0()
{
	byte			*data;
	int				i;
	mapsidedef_t	*msd;
...
void P_LoadBlockMap (int lump)//L80022C00()
{
	int		count;
	int		i;
	int     length;
...
*/
//inline
void P_LoadReject(int lump)//L80022D00()
{
	int length;
...
void P_LoadLeafs(int lump)//L80022D54()
{
	int         i, j;
...
void P_GroupLines (void)//L80022F8C()
{
	line_t		**linebuffer;
	int			i, j, total;
	sector_t	*sector;
...
void P_SetupLevel(int map, skill_t skill)//L800235C8()
{
	int		i, memory;
	...
	/* Load the lump THINGS into the (tempbuffer) */
...
void P_LoadBlocks(char *filename)//L80023C10()
{
    #if 1 /*New Version*/
...
void P_CacheSprite(spritedef_t *sprdef)//L80023ee8()
{
	int i, j, lump;
...
void P_LoadTextureByWidth(int width)//L80023fD8()
{
    side_t *sd;
	int i, w;

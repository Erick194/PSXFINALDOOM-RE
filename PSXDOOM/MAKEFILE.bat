...
::all:
	...
	ccpsx -comments-c++ -Wreturn-type -c -O2 -g -o obj/psx_pad.obj  psx_pad.c
...
::asm:
	...
	ccpsx -O2 -S -Xo$80010000 -o asm\cfm_main.s cfm_main.c
	ccpsx -O2 -S -Xo$80010000 -o asm\m_password.s m_password.c
	ccpsx -O2 -S -Xo$80010000 -o asm\psx_pad.s psx_pad.c

...
void R_RenderBSPNode(int bspnum)//L8002B278()
{
	node_t *bsp;
	//int     side;
	fixed_t	dx, dy;
...
boolean R_CheckBBox(fixed_t bspcoord[4])//L8002B3B0()
{
	int boxx;
	int boxy;
	int boxpos;
...
void R_Subsector(int num)//L8002B814()
{
	subsector_t *sub;
	seg_t       *line;
	int          count;
...
void R_AddLine(seg_t *line)//L8002B8f4()
{
	sector_t    *backsector;
	vertex_t    *vrt, *vrt2;

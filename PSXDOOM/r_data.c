...
void R_InitData (void)//L8002BEE4()
{
    //printf("\nR_InitData\n");
	R_InitPalettes();
	R_InitTextures();
...
void R_InitTextures(void)//L8002BF1C()
{
...
void R_InitFlats(void)//L8002C08C()
{
	psxobj_t    *flat;
	int			lump, i;
...
void R_InitSprite(void)//L8002C190()
{
...
int	R_TextureNumForName(char *name)//L8002C2E0()
{
#if 0
	int		i;
...
int	R_FlatNumForName (char *name)//L8002C3A4()
{
	int			i;
	lumpinfo_t	*lump_p;
	char	name8[8];
...
void R_InitPalettes(void)//L8002C468()
{
	int lump, i, x, y;
	byte *paldata;
	RECT rect;

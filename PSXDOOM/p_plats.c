...
/* */
/*================================================================== */
void	T_PlatRaise(plat_t	*plat)//L8001f6ECC()
{
	result_e	res;
...
/* */
/*================================================================== */
int	EV_DoPlat(line_t *line,plattype_e type,int amount)//L8001f8D0()
{
	plat_t		*plat;
	int			secnum;
	int			rtn;
...
void P_ActivateInStasis(int tag)//L8001FBCC()
{
	int		i;
...
void EV_StopPlat(line_t *line)//L8001FC40()
{
	int		j;
...
void P_AddActivePlat(plat_t *plat)//L8001FCB4()
{
	int		i;
	for (i = 0;i < MAXPLATS;i++)
    {
...
void P_RemoveActivePlat(plat_t *plat)//L8001FD0C()
{
	int		i;
	for (i = 0;i < MAXPLATS;i++)
    {

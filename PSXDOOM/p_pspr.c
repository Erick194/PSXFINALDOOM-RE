...
//inline
void P_RecursiveSound (sector_t *sec, int soundblocks)//L8001FD84()
{
	int			i;
	line_t		*check;
	sector_t	*other;
...
//inline
void P_NoiseAlert (player_t *player)//L8001FEA0()
{
	sector_t	*sec;
...
//inline
void P_SetPsprite (player_t *player, int position, statenum_t stnum) //L8001FFDC()
{
	pspdef_t	*psp;
	state_t	*state;
...
//inline
void P_BringUpWeapon (player_t *player)//L80020084()
{
	statenum_t	new;
...
boolean P_CheckAmmo (player_t *player)//L800201B8()
{
	ammotype_t	ammo;
	int			count;
...
void P_FireWeapon (player_t *player)//L80020428()
{
	statenum_t	new;
...
void P_DropWeapon (player_t *player)//L80020630()
{
	P_SetPsprite (player, ps_weapon, weaponinfo[player->readyweapon].downstate);
}
...
void A_WeaponReady (player_t *player, pspdef_t *psp)//L80020704()
{
	statenum_t	new;
	int			angle;
...
//inline
void A_ReFire (player_t *player, pspdef_t *psp)//L800208EC()
{
	/* */
...
void A_CheckReload(player_t *player, pspdef_t *psp)//L80020988()
{
	P_CheckAmmo(player);
}
...
void A_Lower (player_t *player, pspdef_t *psp)//L800209A8()
{
	psp->sy += LOWERSPEED;
...
void A_Raise (player_t *player, pspdef_t *psp)//L80020B20()
{
	statenum_t	new;
...
void A_GunFlash (player_t *player, pspdef_t *psp) //L80020C0C()
{
...
void A_Punch (player_t *player, pspdef_t *psp) //L80020CE0()
{
	angle_t		angle;
	int			damage;
...
void A_Saw (player_t *player, pspdef_t *psp) //L80020DD8()
{
	angle_t		angle;
	int			damage;
...
void A_FireMissile (player_t *player, pspdef_t *psp) //L80020F50()
{
...
void A_FireBFG (player_t *player, pspdef_t *psp) //L80020FB4()
{
...
void A_FirePlasma (player_t *player, pspdef_t *psp) //L80021018()
{
	player->ammo[weaponinfo[player->readyweapon].ammo]--;
...
//inline
void P_BulletSlope(mobj_t*	mo)//L80021140()
{
	angle_t	an;
...
*/
//inline
void P_GunShot (mobj_t *mo, boolean accurate)//L800211CC()
{
	angle_t		angle;
	int			damage;
...
void A_FirePistol (player_t *player, pspdef_t *psp) //L8002125c()
{
...
void A_FireShotgun (player_t *player, pspdef_t *psp) //L800213E8()
{
	angle_t		angle;
	int			damage;
	int			i;
...
void A_FireShotgun2(player_t *player, pspdef_t *psp)//L80021598()
{
    angle_t		angle;
	int			damage;
	int			i;
...
void A_FireCGun (player_t *player, pspdef_t *psp) //L800217e0()
{
	S_StartSound (player->mo, sfx_pistol);
...
void A_Light0 (player_t *player, pspdef_t *psp)//L800219C8()
{
	player->extralight = 0;
}

void A_Light1 (player_t *player, pspdef_t *psp)//L800219D0()
{
	player->extralight = 8;
}

void A_Light2 (player_t *player, pspdef_t *psp)//L800219DC()
{
...
*/
//inline
void A_BFGSpray (mobj_t *mo) //L800219E8()
{
	int			i, j, damage;
	angle_t		an;
...
void A_BFGsound (player_t *player, pspdef_t *psp)//L80021AD8()
{
...
void A_LoadShotgun2(player_t *player, pspdef_t *psp)//L80021B20()
{
...
void A_CloseShotgun2(player_t *player, pspdef_t *psp)//L80021B44()
{
...
void P_SetupPsprites (int curplayer) //L80021C00()
{
	int	i;
	player_t *player;
...
void P_MovePsprites (player_t *player) //L80021D78()
{
	int			i;
	pspdef_t	*psp;
	state_t		*state;
